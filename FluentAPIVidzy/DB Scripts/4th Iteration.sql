--Command:
--update-database -script -sourceMigration:0 -TargetMigration:ChangesInVideosAndGenresTable -verbose
--The regular commando should be: update-database -script -sourceMigration:0
--but there exists changes in the class model that don't have their migration
--so it was necesary to specify the TargetMigration
